        ...
        <div class="flex-1 overflow-y-auto content-scroll p-10 space-y-6 relative bg-dot-grid">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 relative overflow-hidden hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">₱<?php echo e(number_format($buckets['current']['amount'], 0)); ?></p>
                    <p class="text-[13px] text-gray-500"><?php echo e($buckets['current']['count']); ?> Invoices</p>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 relative overflow-hidden hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">₱<?php echo e(number_format($buckets['d1_30']['amount'], 0)); ?></p>
                    <p class="text-[13px] text-gray-500"><?php echo e($buckets['d1_30']['count']); ?> Invoices</p>
                    <div class="mt-3 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 relative overflow-hidden hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">₱<?php echo e(number_format($buckets['d31_60']['amount'], 0)); ?></p>
                    <p class="text-[13px] text-gray-500"><?php echo e($buckets['d31_60']['count']); ?> Invoices</p>
                    <div class="mt-3 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 relative overflow-hidden hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">₱<?php echo e(number_format($buckets['d61_90']['amount'] + $buckets['d90']['amount'], 0)); ?></p>
                    <p class="text-[13px] text-gray-500"><?php echo e($buckets['d61_90']['count'] + $buckets['d90']['count']); ?> invoices - urgent</p>
                    <div class="mt-3 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    ...
                    <table class="w-full text-[14px] text-left">
                        ...
                        <tfoot class="bg-gradient-to-r from-slate-50 to-slate-100/70 border-t-2 border-gray-200 font-bold text-gray-800 text-[14px]">
                            <tr>
                                ...
                                <td class="px-5 py-4 text-center text-[#16a34a]">₱<?php echo e(number_format($grandTotal['current'], 0)); ?></td>
                                <td class="px-5 py-4 text-center text-[#ef4444]">₱<?php echo e(number_format($grandTotal['d1_30'], 0)); ?></td>
                                <td class="px-5 py-4 text-center text-[#dc2626]">₱<?php echo e(number_format($grandTotal['d31_60'], 0)); ?></td>
                                <td class="px-5 py-4 text-center text-[#b91c1c]">₱<?php echo e(number_format($grandTotal['d61_90'], 0)); ?></td>
                                <td class="px-5 py-4 text-center text-[#991b1b]">₱<?php echo e(number_format($grandTotal['d90'], 0)); ?></td>
                                <td class="px-5 py-4 text-center text-[#4338ca]">₱<?php echo e(number_format($grandTotal['total'], 0)); ?></td>
                                <td></td><td></td>
                            </tr>
                        </tfoot>
                    </table>
    ...
    <script>
        function reportApp() {
            return {
                ...
                overdueFilter: 'all',
                barsLoaded: false,
                agingData: <?php echo json_encode($agingData, 15, 512) ?>,
...
</html><?php /**PATH C:\laragon\www\finance-accounting\resources\views/aging-report.blade.php ENDPATH**/ ?>