...
use App\Models\AccountPayable\Attachment;
...
private function createPaymentJournalEntry(SupplierBill $bill, ?string $reference = null): void
{
    ...
    $amount = $bill->total_paid > 0 ? $bill->total_paid : $bill->amount;
