...
<body class="bg-gray-100">
    <div x-data="{ sidebarOpen: false }" class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            @if(request()->routeIs('reports.manage*') || request()->routeIs('sales-transactions.*') || request()->routeIs('procurement.po.*') || request()->routeIs('procurement.gr.*') || request()->routeIs('procurement.matching.*') || request()->routeIs('supply-chain.*') || request()->routeIs('ar.customer-pay*') || request()->routeIs('sales-refund.*'))
