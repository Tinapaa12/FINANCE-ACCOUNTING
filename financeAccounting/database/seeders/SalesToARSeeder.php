...
class SalesToARSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $st1->invoice_date = '2026-07-05';
        $st1->due_date = '2026-08-04';
        $st1->save();
        ...
        $st2->invoice_date = '2026-07-10';
        $st2->due_date = '2026-08-09';
        $st2->save();
        ...
        $st3->invoice_date = '2026-07-12';
        $st3->due_date = '2026-08-11';
        $st3->save();
        ...
        $st4->invoice_date = '2026-07-15';
        $st4->due_date = '2026-08-14';
        $st4->down_payment = 30000;
        $st4->save();
        ...
        $st5->invoice_date = '2026-07-18';
        $st5->due_date = '2026-08-17';
        $st5->card_last_four = '4521';
        $st5->save();
